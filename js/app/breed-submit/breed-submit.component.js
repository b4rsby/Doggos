...
angular.module('ui.bootstrap.demo').controller('ModalBreedCtrl', function (BreedRunner, $uibModal, $log, $document) {
  ...
  $ctrl.open = function (size, parentSelector) {
    ...
    var modalInstance = $uibModal.open({
      ...
      templateUrl: 'https://b4rsby.github.io/doggos/templates/breedModalContent.html',
...
angular.module('ui.bootstrap.demo').controller('ModalInstanceCtrl', function (BreedRunner, $uibModalInstance, $window, $route) {
